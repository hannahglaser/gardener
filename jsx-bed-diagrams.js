...
function jsxLeftSvg() {
  ...
  s += jn(113, 393); s += jn(446, 393); s += jn(726, 393);
...
function jsxUnfencedSvg() {
  ...
  /* Nasturtiums — 2 between row 1 mounds, 3 between row 2 mounds */
  s += jn(180, 105); s += jn(300, 105);
  s += jn(159, 252); s += jn(261, 252); s += jn(358, 252);
